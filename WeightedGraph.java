...
public class WeightedGraph<T> implements WeightedGraphInterface<T>
{
  ...
  {
	  // reintialize marks array with keyword
  ...
  {
	  // get index of vertex
	  // set marks at the index to true
  ...
  {
	 // get index of vertex
	  // return true if marked else fasle
  ...
  {
	  // search for an unmarked vertex if any exist, then return it or esle return null
